...
/// <summary>A tag information container.</summary>
public class TagData
{
    /// <summary>A field reference to the <see cref="SIMPLE_ERROR"/> field.</summary>
    ...
    /// <summary>A field reference to the <see cref="Runnable"/> field.</summary>
    public static readonly FieldInfo Field_TagData_Runnable = typeof(TagData).GetField(nameof(Runnable));

    /// <summary>A simple error TagData object.</summary>
    ...
    /// <summary>The <see cref="Start"/> field.</summary>
    public static FieldInfo Field_Start = typeof(TagData).GetField(nameof(Start));

    /// <summary>The <see cref="cInd"/> field.</summary>
    public static FieldInfo Field_cInd = typeof(TagData).GetField(nameof(cInd));

    /// <summary>The <see cref="Fallback"/> field.</summary>
    public static FieldInfo Field_Fallback = typeof(TagData).GetField(nameof(Fallback));

    /// <summary>The start of this data.</summary>
    public TemplateTagBase Start;

    /// <summary>What debug mode to use while filling tags.</summary>
    public DebugMode DBMode;

    /// <summary>The current index in this tag.</summary>
    public int cInd = 0;

    /// <summary>The tag's current variable arguments.</summary>
    public Argument[] Variables = null;

    /// <summary>The tag bits this tag data sources from.</summary>
    public TagBit[] Bits = null;

    /// <summary>What to be returned if the tag fills null.</summary>
    public Argument Fallback = null;

    /// <summary>The source argument ID within the command.</summary>
    public string SourceArgumentID = "<none>";

    /// <summary>Whether this tag has an alternate response if it fills null.</summary>
    ...
    /// <summary>The tag system this tag data is used for.</summary>
    public TagHandler TagSystem;

    /// <summary>Gets the command system this tag data is used for (gathered from <see cref="TagSystem"/>).</summary>
    ...
    /// <summary>The 'base color' set by the tag requesting code.</summary>
    public string BaseColor = null;

    /// <summary>What to invoke if there is an error. Used for setting a resultant call. If an error is encountered in a tag, use <see cref="Error(string)"/>.</summary>
    public Action<string> ErrorHandler;

    /// <summary>Helper for <see cref="Action"/>s, a no-return call to <see cref="Error(string)"/>.</summary>
    ...
    /// <summary>Helper call to handle an error case without generating a full error message if available. No guaranteed exit.</summary>
    ...
    /// <summary>Callable action for handling errors.</summary>
    public Action<string> ErrorAction;

    /// <summary>The relevant command runnable, if any.</summary>
    public CompiledCommandRunnable Runnable;

    /// <summary>Runs a clean error for this tag.</summary>
    ...
    /// <summary>Constructs an empty unfilled tag data (FILL THIS OBJECT AFTER USING THIS).</summary>
    public TagData()
    {
    ...
    /// <summary>How many tag positions are left.</summary>
    ...
    /// <summary>Gets the modifier at the current position, handling any tags within - returning a string.</summary>
    ...
    /// <summary>Gets the modifier at a specified place, handling any tags within - returning a string.</summary>
    ...
    /// <summary>Reference to <see cref="GetModifierObjectKnown(int)"/>.</summary>
    public static MethodInfo Method_GetModiferObjectKnown = typeof(TagData).GetMethod(nameof(GetModifierObjectKnown));

    /// <summary>Gets the modifier at a specified place, handling any tags within.</summary>
    ...
    /// <summary>Reference to <see cref="GetModifierObjectCurrent"/>.</summary>
    public static MethodInfo Method_GetModifierObjectCurrent = typeof(TagData).GetMethod(nameof(GetModifierObjectCurrent));

    /// <summary>Gets the modifier at the current position, handling any tags within.</summary>
    /// <returns>The tag-parsed modifier.</returns>
