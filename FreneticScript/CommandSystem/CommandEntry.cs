...
/// <summary>All the information for a command being currently run.</summary>
public class CommandEntry
{
    /// <summary>The named argument ID for the name of a variable to save into.</summary>
    public const string SAVE_NAME_ARG_ID = "\0varname";

    /// <summary>The system controlling this CommandEntry.</summary>
    public ScriptEngine System;

    /// <summary>The relevant tag system.</summary>
    ...
    /// <summary>The index of this entry in its block.</summary>
    public int OwnIndex;

    /// <summary>The original command input.</summary>
    public string CommandLine;

    /// <summary>A list of all commands that were inside this command originally.</summary>
    public CommandEntry[] InnerCommandBlock = null;

    /// <summary>All 'named' arguments on this command entry.</summary>
    public Dictionary<string, Argument> NamedArguments;

    /// <summary>The start of this command's braced block.</summary>
    public int BlockStart;

    /// <summary>The end of this command's braced block.</summary>
    public int BlockEnd;
    ...
    /// <summary>The name of the creating script.</summary>
    public string ScriptName;

    /// <summary>The line number in the creating script.</summary>
    public int ScriptLine;

    /// <summary>The inner command block as its own script, generated by command execute methods where needed.</summary>
    public CommandScript BlockScript = null;

    /// <summary>The debug mode for this specific entry.</summary>
    public DebugMode DBMode = DebugMode.FULL;

    /// <summary>The original CCSE that contains this entry.</summary>
    public CompiledCommandStackEntry CCSE;

    /// <summary>Gets the correct debug mode for this entry and a specified queue.</summary>
    ...
    /// <summary>Gets the full command string that represents this command.</summary>
    ...
    /// <summary>Space to include in front of this entry when outputting it as text.</summary>
    public string FairTabulation = "";

    /// <summary>The command name input by the user.</summary>
    public string Name = "";

    /// <summary>The command that should execute this input.</summary>
    public AbstractCommand Command;

    /// <summary>The arguments input by the user.</summary>
    public Argument[] Arguments;

    /// <summary>What command prefix was used for this command, if any.</summary>
    public CommandPrefix Prefix;

    /// <summary>The save variable location, if any.</summary>
    public int SaveLoc = -1;

    /// <summary>Gets the save name for this entry, without parsing it.</summary>
    ...
    /// <summary>Returns whether the entry is able to save a result.</summary>
    public bool CanSave
    {
        get
        {
    ...
    /// <summary>A generated save result action.</summary>
    ...
    /// <summary>Gets an argument at a specified place, handling any tags.</summary>
    /// <param name="queue">The command queue involved.</param>
    ...
    /// <summary>Gets an argument at a specified place, handling any tags - returning a string.</summary>
    /// <param name="queue">The command queue involved.</param>
    /// <param name="place">The argument place number.</param>
    ...
    /// <summary>Gets all arguments piled together into a string.</summary>
    /// <param name="queue">The command queue involved.</param>
    ...
    /// <summary>Gets all arguments (without parsing) piled together into a string.</summary>
    /// <param name="index">The index to start at.</param>
    /// <returns>The combined string.</returns>
    ...
    /// <summary>Used to output requested information.</summary>
    /// <param name="queue">The command queue involved.</param>
    /// <param name="text">The text to output.</param>
    public static void InfoOutput(CommandQueue queue, string text)
    {
    ...
    /// <summary>Sets the data associated with this entry in the queue.</summary>
    ...
    /// <summary>Gets the data associated with this entry in the queue.</summary>
    /// <param name="queue">The queue holding the data.</param>
    /// <returns>The entry data.</returns>
    ...
    /// <summary>Used to output a failure message. This is considered a 'warning' and will not induce an error.</summary>
    /// <param name="queue">The command queue involved.</param>
    /// <param name="text">The text to output.</param>
    ...
    /// <summary>Perfectly duplicates the command entry.</summary>
    ...
    /// <summary>A lookup table for CIL variables.</summary>
